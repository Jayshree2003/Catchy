...
//        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.ic_heart));
        ...
        drawableResList.add(R.drawable.ic_link_foreground);
        drawableResList.add(R.drawable.ic_add);
        drawableResList.add(R.drawable.ic_schedule_foreground);
        drawableResList.add(R.drawable.ic_twotone_smessage_foreground);
      ...
      tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.ic_twotone_smessage_foreground));
...
//                        tabLayout.getTabAt(0).setIcon(R.drawable.ic_home_fill);
                    ...
                    case 1:
                        tab.setIcon(R.drawable.ic_link_foreground);
                        break;
                    ...
                    case 3:
                        tab.setIcon(R.drawable.ic_twotone_schedule_foreground);
                        break;

                    case 4:
                        tab.setIcon(R.drawable.ic_message_foreground);
                        break;
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    ...
                    case 3:
                        tab.setIcon(R.drawable.ic_schedule_foreground);
                        break;

                    case 4:
                        tab.setIcon(R.drawable.ic_twotone_smessage_foreground);
                        break;
